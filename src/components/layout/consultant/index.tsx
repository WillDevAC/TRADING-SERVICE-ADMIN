...
import SidebarMobile from "../../molecules/sidebar_consultant/mobile";
import SidebarDesktop from "../../molecules/sidebar_consultant/desktop";
...
const layout_consultant: React.FC<IProps> = ({
  children,
  title,
  isBreadcrumb,
  isBack,
...
export default layout_consultant;
