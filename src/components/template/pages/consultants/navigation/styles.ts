...
export const NavigationContainer = tw.div`
  h-16 flex items-center lg:items-stretch
...
export const NavigationUl = tw.div`
  p-2 w-full border-r bg-white absolute
  rounded left-0 shadow mt-12 sm:mt-16
`;

export const NavigationLi = tw.div`
  flex w-full justify-between text-gray-600
  hover:text-indigo-700 cursor-pointer items-center
`;
